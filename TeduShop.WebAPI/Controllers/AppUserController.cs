    ...
    public class AppUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                IEnumerable<AppUserViewModel> appUserViewModels = modelVm as AppUserViewModel[] ?? modelVm.ToArray();
                foreach (AppUserViewModel appUserViewModel in appUserViewModels)
                {
                    appUserViewModel.BirthDay = appUserViewModel.BirthDay.Substring(0, 10);
                }
        ...
        public async Task<HttpResponseMessage> Details(HttpRequestMessage request, string id)
        {
            ...
            else
            {
                ...
                applicationUserViewModel.BirthDay = applicationUserViewModel.BirthDay.Substring(0, 10);
